...
public class StudentsProvider extends ContentProvider {
    static final String PROVIDER_NAME = "com.example.eeaassignment.StudentsProvider";
    ...
    static final String DATABASE_NAME = "Workers";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)){
            ...
            case EMPLOYEE_ID:
                ...
                count = db.delete( EMPLOYEE_TABLE_NAME, _ID +  " = " + id , selectionArgs);
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case EMPLOYEE_ID:
                count = db.update(EMPLOYEE_TABLE_NAME, values,
                        _ID + " = " + uri.getPathSegments().get(1), selectionArgs);
