        ...
        getItem .enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                if(viewItem != null){
                    ...
                    Toast.makeText(UpdateProfile.this, "Profile of "+viewItem.getUsername(), Toast.LENGTH_SHORT).show();
                    Log.d("myTag", "method is called");
                }
                else{

                    Toast.makeText(UpdateProfile.this, "Check inputs and try again!", Toast.LENGTH_SHORT).show();
