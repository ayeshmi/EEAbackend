...
public class ViewAllUser extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(search.getText().toString()) ){
                    Toast toast =  Toast.makeText(ViewAllUser.this,"Input Required", Toast.LENGTH_LONG);
                    toast.show();
    ...
    public void search(String seachWord){
        Call<List<User>> getAllUserCall = ApiClient.getUserService().advanceUserSearch(seachWord);
        getAllUserCall.enqueue(new Callback<List<User>>() {
            @Override
            public void onResponse(Call<List<User>> call, Response<List<User>> response) {
