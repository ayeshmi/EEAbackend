...
public class ViewCart extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
        ...
        getAllCartCall.enqueue(new Callback<List<Order>>() {
            ...
            public void onResponse(Call<List<Order>> call, Response<List<Order>> response) {
                ...
                if(order != null){
                    ...
                    lv.setAdapter(new CartAdapter(ViewCart.this, order));
                    lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        @Override
                        public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                            ListItem user = (ListItem) lv.getItemAtPosition(position);
                            Toast.makeText(ViewCart.this, "Selected :" + " " + user.getName()+", "+ user.getLocation(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                else{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        NavBarHandler.navBarHandlerUser(item,ViewCart.this);
